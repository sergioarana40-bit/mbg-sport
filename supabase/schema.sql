...
-- ---------- Banner comercial de la portada de la tienda ----------
-- "Destacado de la semana" administrable desde /admin/banner; con varios
-- activos, la portada los rota en carrusel (diseño "Entrega MBGSPORT").
